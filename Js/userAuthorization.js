...
let boxPar = document.getElementById('maintable');
...
//boxPar.addEventListener('contextmenu', showmenu);
...
for (var box of collapseOneCheckBoxes) {
    box.onclick = function () {
        ...
        //
        var mainCheckBoxTrigger = true;

        for (var item of collapseOneCheckBoxes) {
            if (item.checked == false) {
                mainCheckBoxTrigger = false;
                break;
            }
        }
...
// permission to users by checkboxes end here
