...
//overflov none and blok function
menuBtn.addEventListener('click', SlideAside);
$(".checkbox").click(function () {
    $(".overflov-block").toggleClass("d-none");
    $(".saveButton").toggleClass("d-block");
...
function savaeAdd() {
    ...
    table.className = "static-tr-name-child";
...
var box = document.getElementById("maintable"),rIndex;
           
for(var i = 1; i < box.rows.length; i++)
{
    box.rows[i].onclick = function () {
        if (checkBox.checked == false) {

            rIndex = this.rowIndex;
            $(".overflov-block").addClass("d-none");
            ...
            $(".saveButton").addClass("d-none");
            document.querySelector('.saveButton').style = "display:none!important";
            document.querySelector('.addButton').style = "display:block!important";
...
function editAdd()
{
    box.rows[rIndex].cells[0].innerHTML = document.getElementById("name").value;
    box.rows[rIndex].cells[1].innerHTML = document.getElementById("code").value;
...
function createNew() {
    if (checkBox.checked == true) {
        $(".overflov-block").addClass("d-none");
        document.querySelector('.saveButton').style = "display:block!important";
        document.querySelector('.addButton').style = "display:none!important";
...
checkBox.addEventListener('click', createNew)
